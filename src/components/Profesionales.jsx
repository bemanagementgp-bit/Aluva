...
/*
  ...
  Es el objetivo comercial número uno del año (ver CONTEXTO.MD) y la única
  sección que le habla a ese público. Usa el recurso de la palabra gigante de
  Hitachi CM ("ORANGE FAMILY"): la palabra en verde de marca ocupa todo el
  ancho, abajo un filete corto, un titular de peso mixto y cuatro razones de
  una línea. Todo lo que dice está confirmado en el brief.
*/
